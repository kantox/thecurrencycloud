...
require File.expand_path('lib/thecurrencycloud/version')
...
Gem::Specification.new do |s|
  ...
  s.require_paths = ["lib"]
  s.summary = %q{A library which implements the complete functionality of v1 of The Currency Cloud Connect API.}
  s.test_files = `git ls-files -- {test,spec,features}/*`.split("\n")
  s.version = TheCurrencyCloud::VERSION
